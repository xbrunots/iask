...
interface IRegistroAtendimentoTwo {
  close: Function;
}
const RegistroAtendimentoTwo: React.FC<IRegistroAtendimentoTwo> = (
  props: IRegistroAtendimentoTwo
) => {
  function onClose() {
    props.close();
  }
...
export default RegistroAtendimentoTwo;
